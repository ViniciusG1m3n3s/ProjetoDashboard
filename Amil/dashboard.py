...
# Botão para exportar o relatório para Excel
        excel_data = exportar_para_excel(df_tmo_por_carteira)

        if excel_data:
            st.download_button(
                label="Baixar Relatório Excel",
                data=excel_data,
                file_name="relatorio_tmo.xlsx",
